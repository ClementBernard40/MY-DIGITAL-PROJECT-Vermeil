  ...
  return (
    <div className='mt-[100px]'>
      ...
      <div className="relative">
        <img src="/yellow_bg.png" alt="" className=" mt-[100px] xl:h-[60vw] 2xl:h-[70vw] mdxl:h-[65vw] md:h-[75vw] absolute top-0 left-0" />
        <div className="absolute top-44 md:w-[80%] 2xl:w-[47%] xl:w-[60%] lg:w-[70%] 3xl:w-[30%] mt-[100px] ARCO text-orangee lg:text-6xl text-4xl left-1/2 transform -translate-x-1/2 block text-center">
        ...
        <div className="absolute lg:top-80 top-60 w-full mt-[100px] text-center">
        ...
        <img src="/apple2.png" alt="" className="absolute left-32 w-[20%]" style={{ top: '500px' }} />
        <img src="/tomato2.png" alt="" className="absolute left-1/2 transform -translate-x-1/2 w-[20%]" style={{ top: '500px' }} />
        <img src="/bread2.png" alt="" className="absolute right-32 w-[20%]" style={{ top: '500px' }} />
