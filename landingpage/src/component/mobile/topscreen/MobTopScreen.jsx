  ...
  return (
    <div>
      ...
      <div className="relative">
        ...
        <img src="/apple.png" alt="" className="absolute left-1/2 transform -translate-x-1/2 w-[75%] top-[500px]" style={{ marginTop: '10vw' }} />
        <img src="/tomato.png" alt="" className="absolute left-1/2 transform -translate-x-1/2 w-[75%] top-[800px] wsm:mt-[35vw] mt-[15vw] sm:mt-[50vw]" />
        <img src="/bread.png" alt="" className="absolute left-1/2 transform -translate-x-1/2 w-[75%] top-[1100px] wsm:mt-[55vw] mt-[15vw] sm:mt-[90vw]" />
